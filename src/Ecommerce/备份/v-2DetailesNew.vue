...
export default{
	...
	methods:{
		...
		serachInfo(){
			if(this.getUrlKey('mallId')!=''){
				setCookie('mallId', this.getUrlKey('mallId'),1000*60)
				this.searchInfo.mallId=this.getUrlKey('mallId')
			}else{
				this.searchInfo.mallId = getCookie('mallId')
			}
			alert(this.getUrlKey('mallId'))
			alert(this.searchInfo.mallId )
	    ...
	    serachAmount(){
	    	if(this.getUrlKey('mallId')!=''){
				setCookie('mallId', this.getUrlKey('mallId'),1000*60)
				this.mallId=getCookie('mallId')
			}else{
				this.mallId = getCookie('mallId')
			}
			alert(getCookie('mallId'))
			alert(this.mallId )
